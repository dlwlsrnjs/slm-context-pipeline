...
def build_prl_student_prompt(seed_examples: str, shots: int,
    ...
    # v3: user_question ONLY (no candidate examples)
    return (
        ...
        "  - what operations and reasoning are needed for the user's question\n"
        "  - what patterns / structures across your 4 demos will help that question\n"
        "  - what variations to cover related cases\n\n"
